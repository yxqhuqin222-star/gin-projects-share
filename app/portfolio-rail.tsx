...
function RailIcon({ id }: { id: string }) {
  ...
  if (id === "work") {
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24">
        <path d="M4.5 6h5l1.4 1.6h8.6A1.5 1.5 0 0 1 21 9.1v9.4a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 18.5v-11A1.5 1.5 0 0 1 4.5 6Zm.5 4v7.5a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5V10H5Z" />
      </svg>
    );
  }
